...
export function buildSeed() {
  ...
  const drivers = [
    ...
    },
    {
      ...
      name: "SARAVANAN",
      phone: "9841251747",
      licenseNumber: "TN-22-2021-005432",
      licenseExpiry: "2027-06-30",
      experienceYears: 10,
      status: "active",
      assignedBusId: "bus-23",
      createdAt: now,
    },
    {
      id: "driver-6",
      name: "PANDIAN",
      phone: "8838312284",
      licenseNumber: "TN-11-2022-003891",
    ...
    },
    {
      ...
      name: "BALAMURUGAN",
      phone: "8610378819",
      licenseNumber: "TN-11-2020-002156",
      licenseExpiry: "2026-09-30",
      experienceYears: 14,
      status: "active",
      assignedBusId: "bus-29",
      createdAt: now,
    },
    {
      id: "driver-8",
      name: "NARAYANAN",
      phone: "9840306310",
      licenseNumber: "TN-11-2023-007845",
      licenseExpiry: "2028-04-20",
      experienceYears: 7,
      status: "active",
      assignedBusId: "bus-31",
      createdAt: now,
    },
    {
      id: "driver-9",
      name: "NAAINAR",
      phone: "9677223360",
      licenseNumber: "TN-19-2021-004523",
      licenseExpiry: "2027-10-10",
      experienceYears: 11,
      status: "active",
      assignedBusId: "bus-33",
      createdAt: now,
    },
    {
      id: "driver-10",
      name: "SELLA THURAI",
      phone: "9840061417",
      licenseNumber: "TN-21-2022-006198",
      licenseExpiry: "2027-07-25",
      experienceYears: 9,
      status: "active",
      assignedBusId: "bus-37",
      createdAt: now,
    },
  ];
